...
void full_exec(char** word_array, int* cmd_size){
	FILE* file;
	int i =0;
	int bin=0; //On va compter le nombre de mots qui sont liés à la redirection
	...
	*cmd_size -=bin; // On supprime les éléments lié à la redirection afin d'exécuter la commande sans problème
